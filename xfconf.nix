...
xfce4-panel = {
          ...
          "plugins/plugin-6/digital-date-font" = "Sans Bold 10";
          "plugins/plugin-6/digital-layout" = 3;
          "plugins/plugin-6/digital-time-font" = "Sans Bold 10";
          "plugins/plugin-6/digital-time-format" = "%a %d %R";
          "plugins/plugin-6/timezone" = "UTC";
          # 7
